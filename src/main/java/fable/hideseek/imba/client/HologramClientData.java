...
public final class HologramClientData {
    public record Projector(int id,int location,String world,double x,double y,double z,float yaw,float scale,int light,boolean textBackground,float contrast,float textScale,int titleBreak){}
